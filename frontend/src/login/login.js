...
function Login({signupParam}) {
    ...
    function signupOnClick() {
        ...
        console.log(user);
        axios
        .post("https://qatar2022worldcupreservationsystem.onrender.com/users/signup", {
    ...
    function loginOnClick() {
        axios
        .post("https://qatar2022worldcupreservationsystem.onrender.com/users/signin", {
            "username": user.username,
            "password": user.password,
        })
        .then((res) => {
                ...
                <div className='form-container'>
                        ...
                        <div className='form-wrapper'>
                            {signup && <div className='Name-container'>
                                <div className='first-name'>
                                    <input type='text' name='firstname' id='firstname' placeholder='First name' onChange={(e) => setUserOnChange(e)} />
                                </div>
                                <div className='last-name'>
                                    <input type='text' name='lastname' id='lastname' placeholder='Last name' onChange={(e) => setUserOnChange(e)} />
                                </div>
                            </div>}
                            ...
                            {signup && <div className='birth-date-container'>
                                ...
                                <DatePicker className="DatePicker" name='birthDate' format='dd/MM/yyyy' onChange={onDateChange} value={dateValue} />
                            </div>}
                            ...
                            {signup && <div className='nationality-container'>
                                ...
                                <div className='input'>
                                    <input type='text' name='nationality' id='nationality' placeholder='nationality' onChange={(e) => setUserOnChange(e)}/>
                                </div>
                            </div>}
                            ...
                            {signup && <div className='email-container'>
                                ...
                                <div className='input'>
                                    <input type='email' name='email' id='email' placeholder='email' onChange={(e) => setUserOnChange(e)}/>
                                </div>
                            </div>}
                            ...
                            {signup && <div className='gender-container'>
                                ...
                                <div className='gender'>
                                    <Dropdown className="Dropdown" name='gender' options={['Male', 'Female']} value={''} 
                                    placeholder="Select your gender" onChange={(e) => setGenderOnChange(e)}/>
                                </div>
                            </div>}
                            ...
                            <div className='username-container'>
                                ...
                                <div className='input'>
                                    <input type='text' name='username' id='username' placeholder='username' onChange={(e) => setUserOnChange(e)}/>
                                </div>
                            </div>
                            <div className='password-container'>
                                ...
                                <div className='input'>
                                    <input type='password' name='password' id='password' placeholder='password' onChange={(e) => setUserOnChange(e)}/>
                                </div>
                            </div>
                            {signup && <div className='choose-role'>
                                <div className='choose-role-container'>
                                    <div className='label'>Sign Up as admin </div>
                                    <input type='checkbox' name='role' id='role' onChange={(e) => setUserOnChange(e.target.value ? "manager" : "fan")}/>
                                </div>
                            </div>}
                        </div>
                    </div>
                    <div className='footer'>
                        <div className='button-container'>
                            <button onClick={()=>{{!signup && loginOnClick();} {signup && signupOnClick();} }}>{signup ? 'SignUp' : 'Login'}</button>
                        </div>
