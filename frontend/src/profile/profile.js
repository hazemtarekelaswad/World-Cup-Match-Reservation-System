            ...
            <div className="profile-content">
                ...
                <div className="content-wrapper">
                    ...
                    <div className="profile-item">
                        ...
                        <div className="field-container">
                            <div className="profile-field">
                                <input type='text' name='firstname' id='firstname' placeholder='First name' defaultValue={profile.firstname} disabled={fname} />
                            </div>
                            <div className="edit-icon" onClick={()=>setFname(false)}>
                                <FontAwesomeIcon className='profile-icon' icon={faPenToSquare} />
                            </div>
                        </div>
                    </div>
                    <div className="profile-item">
                        ...
                        <div className="field-container">
                            <div className="profile-field">
                                <input type='text' name='lastname' id='lastname' placeholder='Last name' defaultValue={profile.lastname} disabled={lname} />
                            </div>
                    ...
                    <div className="profile-item">
                        ...
                        <div className="field-container">
                            <div className="profile-field">
                                {gender === true && (profile.gender === 'F' ? 'Female' : 'Male')}
                                {gender === false && <Dropdown className="Dropdown" options={['Male', 'Female']} value={profile.gender === 'F' ? 'Female' : 'Male'} placeholder="Select your gender" disabled={gender}/>}
                            </div>
                    ...
                    <div className="profile-item">
                        ...
                        <div className="field-container">
                            <div className="profile-field">
                                ...
                                {birthDate === false && <DatePicker className="DatePicker" onChange={onDateChange} value={dateValue} disabled={birthDate}/>}
                            </div>
                    ...
                    <div className="profile-item">
                        ...
                        <div className="field-container">
                            <div className="profile-field">
                                <input type='text' name='nationality' id='nationality' placeholder='Nationality' defaultValue={profile.nationality} disabled={nationality} />
                            </div>
                            <div className="edit-icon" onClick={()=>setNationality(false)}>
                                <FontAwesomeIcon className='profile-icon' icon={faPenToSquare} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="profile-item">
                        ...
                        <div className="field-container">
                            <div className="profile-field">
                                ...
                                {password === false && <input type='passowrd' name='password' id='password' placeholder='password' defaultValue={profile.password} disabled={password}/>}
                            </div>
                    ...
                    {password === false && <div className="profile-item">
                        <div className="label">
                            Confirm passowrd:
                        </div>
                        <div className="field-container">
                            <div className="profile-field">
                                <input type='passowrd' name='password' id='password' placeholder='confirm password' defaultValue={''} disabled={password}/>
                            </div>
                            <div className="edit-icon">
                            </div>
                        </div>
